...
# ===========================================================================
HOST = "jpool09"   # shown as  jpool09@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Product Owner @ Dojo Coding"),
    ("kv", "Prev", "Full Stack Dev @ Bamboo / Mythicbyte"),
    ("kv", "Also", "Founder @ Shaloom"),
    ("kv", "Edu", "B.Sc. Systems Eng, U. Latina '19"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, TypeScript, Tailwind, Vite"),
    ("kv", "Backend", "Supabase, SQL, PHP"),
    ("kv", "Tooling", "Sentry, PostHog, Storybook"),
    ("kv", "Web3", "Blockchain, Monad"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "PO of Dojo OS Hackathons platform"),
    ("bul", "Founder of Shaloom (photobooks)"),
    ("bul", "Building Monadeum, AI Agent Arena on Monad"),
]
